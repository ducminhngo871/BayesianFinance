...
data %>% 
  ...
  ggtitle("Same Year")
data %>% 
  ggplot(aes(y = EARNINGS_Scaled, x= SALES_1_YEAR_AGO, color = Sector))+
  geom_point(alpha = 0.20)+
  geom_smooth(method = 'lm', formula = y ~ x)+
  theme_minimal()+
  ggtitle("1 year go Year")
data %>% 
  ggplot(aes(y = EARNINGS_Scaled, x= SALES_2_YEAR_AGO, color = Sector))+
  geom_point(alpha = 0.20)+
  geom_smooth(method = 'lm', formula = y ~ x)+
  theme_minimal()+
  ggtitle("2 year go Year")
data %>% 
  ggplot(aes(y = EARNINGS_Scaled, x= SALES_3_YEAR_AGO, color = Sector))+
  geom_point(alpha = 0.20)+
  geom_smooth(method = 'lm', formula = y ~ x)+
  theme_minimal()+
  ggtitle("3 year go Year")
```
